...
const ubahnData = {
  type: "ubahn" as const,
  title: <a href="#ubahn" className="text-blue-500 hover:underline">U-Bahn (Subway)</a>,
...
const sbahnData = {
  type: "sbahn" as const,
  title: <a href="#sbahn" className="text-blue-500 hover:underline">S-Bahn (City Train)</a>,
...
const tramData = {
  type: "tram" as const,
  title: <a href="#tram" className="text-blue-500 hover:underline">Tram (Streetcar)</a>,
...
const busData = {
  type: "bus" as const,
  title: <a href="#bus" className="text-blue-500 hover:underline">Bus</a>,
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <section id="ubahn" className="py-8">
          <div className="container mx-auto px-4">
            <TransportCard transport={ubahnData} />
          </div>
        </section>

        <section id="sbahn" className="py-8">
          <div className="container mx-auto px-4">
            <TransportCard transport={sbahnData} />
          </div>
        </section>

        <section id="tram" className="py-8">
          <div className="container mx-auto px-4">
            <TransportCard transport={tramData} />
          </div>
        </section>

        <section id="bus" className="py-8">
          <div className="container mx-auto px-4">
            <TransportCard transport={busData} />
          </div>
        </section>
